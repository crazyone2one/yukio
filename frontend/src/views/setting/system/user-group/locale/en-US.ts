export default {
  system: {
    userGroup: {
      ...
      pleaseInputUserGroupName:
        'Please input user group name,and not equal to system user group name',
      ...
      removeName:
        'Confirm to remove {name} this user After removal, the User Group permission will be lost',
