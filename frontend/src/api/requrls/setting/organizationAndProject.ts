...
// 获取系统下所有组织-Table
export const postOrgTableUrl = '/system/organization/page'
// 获取组织下所有项目-Table
...
// 获取用户列表
export const getUserTableByOrgIdOrProjectIdUrl =
  '/organization/project/user-list/'
// 恢复项目
export const getRecoverProjectByOrgUrl = '/organization/project/revoke/'
// 移除项目成员
export const getDeleteProjectMemberByOrgUrl =
  '/organization/project/remove-member/'
// 启用项目
...
// 获取管理员下拉选项
export const getAdminByOrganizationOrProjectUrl =
  '/organization/project/user-admin-list/'
// 系统或组织-获取项目资源池下拉选项
