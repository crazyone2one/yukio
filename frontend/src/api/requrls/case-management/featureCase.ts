...
// 创建模块树
export const CreateCaseModuleTreeUrl = '/functional/case/module/save'
// 更新模块树
...
// 获取回收站模块数量
export const GetRecycleCaseModulesCountUrl =
  '/functional/case/trash/module/count'
// 获取全部用例模块数量
...
// 批量彻底删除回收站用例表
export const BatchDeleteRecycleCaseListUrl =
  '/functional/case/trash/batch/delete'
// 恢复回收站单个用例
...
// 批量关联需求
export const BatchAssociationDemandUrl =
  '/functional/case/demand/batch/relevance'
// 取消关联
...
// 获取用例详情弹窗关联用例接口用例
export const GetAssociationPublicCasePageUrl =
  '/functional/case/test/associate/case/page'
// 获取接口测试接口模块数量
export const GetAssociationPublicCaseModuleCountUrl =
  '/functional/case/test/associate/case/module/count'
// 获取用例详情接口模块树
export const GetAssociationPublicModuleTreeUrl =
  '/functional/case/test/associate/case/module/tree'
// 获取前后置用例列表
export const GetDependOnPageUrl = '/functional/case/relationship/page'
// 用例管理-功能用例-用例详情-前后置关系
export const GetDependOnRelationUrl =
  '/functional/case/relationship/relate/page'
// 添加前后置关系
...
// 获取关联用例已关联列表
export const GetAssociatedDrawerCaseUrl =
  '/functional/case/test/has/associate/case/page'
// 获取用例详情缺陷
...
// 取消关联缺陷
export const CancelAssociatedDebuggerUrl =
  '/functional/case/test/disassociate/bug'
// 获取详情已关联缺陷列表
export const GetAssociatedDebuggerUrl =
  '/functional/case/test/has/associate/bug/page'
// 获取前后置已关联用例ids
export const GetAssociatedCaseIdsUrl = '/functional/case/relationship/get-ids'
// 导入功能
// 功能用例导入excel下载模板
export const DownloadExcelTemplateUrl =
  '/functional/case/download/excel/template'
// 富文本所需资源上传
