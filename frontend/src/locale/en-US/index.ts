...
const _Cmodules: any = import.meta.glob('../../components/**/locale/en-US.ts', {
    eager: true,
})
const _Vmodules: any = import.meta.glob('../../views/**/locale/en-US.ts', {
    eager: true,
})
let result = {}
...
export default {
    message: {
        ...
        'menu.caseManagement.caseManagementReviewDetailCaseDetail':
            'Review Case Detail',
        ...
        'menu.settings.organization.templateManagementDetail':
            'Create Template',
        'menu.settings.organization.templateManagementWorkFlow':
            'WorkFlow Setting',
